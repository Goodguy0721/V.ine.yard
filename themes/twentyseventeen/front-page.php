...
<section id="welcome" class="parallax fullscreen">
	...
	<article>
		<div>
			...
			<p>Our focus on classic vinifera includes <em>Chardonnay</em>, <em>Pinot Noir</em>, <em>Riesling</em>, and other German-styled whites specifically selected for our microclimates.</p>
			<p>We’re maximizing the expression of our wines by practicing biodynamic viticulture in some of the <em>Annapolis Valley’s</em> most privileged vineyard sites. Our intention from the beginning has been an unwavering dedication to quality throughout the wine’s journey.</p>
			<p>Lightfoot &amp; Wolfville’s new retail facility will be opening to the public in 2017.</p>
		</div>
	</article>
</section>
...
<section class="blockquote">
	<figure class="quote">
		<blockquote id="quote-reader">
			<h1>A message from <em>Peter Gamble</em></h1>

			<p>One indisputable truth that every generation of winemakers learns and relearns, is that the finest wines come from the finest vineyards, grown and nurtured by farmers and viticulturists respectful of the land’s particular gifts and energies. Great wine is grown. So for the best stewards of those sites, we use the term “winegrowers” &mdash; just as we do for great artisan winemakers with deeply intuitive ties to their vines and their best soils.</p>
			<p>For over five years now, I have worked with the Lightfoot team &mdash; first as new viticulturists, and then as an emergent winery &mdash; and I can confidently say that they are winegrowers. And, moreover, they are advancing viticulture in the province: not only are they growing the classic champagne varieties to produce top-flight traditional sparklings, they are poised to forever change the face of classic Burgundian- and Germanic-influenced wines, as well.</p>
			<p>As all of this unfolds, this website will allow wine lovers in Canada to keep a close ear to the ground.</p>

			<p>
				Peter Gamble - World Renowned Wine Consultant
				<span class="signature">
					<img src="assets/images/peter-gamble-signature.svg" alt="Peter Gamble Signature">
				</span>
		...
		<div class="quote-player" id="quote-player">
			...
			<div class="title">
				<h1>A message from <cite>Peter Gamble</cite></h1>
				<h2>World renowned wine consultant</h2>
...
<section id="the-wine" class="fullscreen parallax">
	<div class="intro">
		<h1>The Wine</h1>
		<p>Artisanal wines that speak of their origin.</p>
...
<section class="info">
	<figure class="bio-dynamic-cow-horns red">
		<img src="./assets/images/info/bio-dynamic-cow-horns.jpg" alt="Bio dynamic cow horns">
		<figcaption>
	...
	<figure class="basket-wine-press green">
		<img src="./assets/images/info/basket-wine-press.jpg" alt="Basket wine press">
		<figcaption>
			<button>Show information</button>
			<p>
	...
	<figure class="english-baby-doll-sheep blue">
		<img src="./assets/images/info/english-baby-doll-sheep.jpg" alt="English Baby-Doll sheep">
		<figcaption>
			<button>Show information</button>
			<p>
...
<section id="the-land" class="yield fullscreen parallax">
	<div class="intro">
		<h1>The Land</h1>
		<p>
			<span class="latitude">45.0833</span><span class="label">&deg; N</span>,
			<span class="longitude">64.3667</span><span class="label">&deg; W</span>
		</p>
...
<section class="info">
	<figure class="acadian-artifacts dark-green">
		<img src="./assets/images/info/acadian-artifacts.jpg" alt="Acadian artifacts">
		<figcaption>
			<button>Show information</button>
			<p>
	...
	<figure class="hawk red">
		<img src="./assets/images/info/hawk.jpg" alt="Hawk">
		<figcaption>
			<button>Show information</button>
			<p>
	...
	<figure class="cellar-door green">
		<img src="./assets/images/info/cellar-door.jpg" alt="Cellar Door">
		<figcaption>
			<button>Show information</button>
			<p>
	...
	<div class="logo-breakdown">
		...
		<p>
			<span class="ampersand">
				<img src="./assets/images/ampersand.svg" alt="Lightfoot &amp; Wolfville Vineyards Logo Ampersand">
			</span>
...
<section id="the-vines" class="yield fullscreen parallax">
	...
	<article>
		<div>
			<h1>Wine Growing</h1>
			<div class="columns">
				<p>The selection of our varietals at Lightfoot &amp; Wolfville has been made with close attention to each specific vineyard – their soil makeup, direct ocean influence, elevated hillside locations, and our growing understanding, season by season, of what makes them produce the best wines.</p>
				<p>Certified organic and grown according to the principles of biodynamic agriculture, our wines include classic Burgundian-inspired Chardonnay and Pinot Noir, Rieslings and other German-styled white wines, as well as traditional method prestige cuvée sparkling wines. Ours is the most diverse portfolio of classic European vinifera in Atlantic Canada.</p>
...
<section class="info">
	<figure class="grape-cluster green">
		<img src="./assets/images/info/grape-cluster.jpg" alt="Grape cluster">
		<figcaption>
			<button>Show information</button>
			<p>
	...
	<figure class="crushed-grapes blue">
		<img src="./assets/images/info/crushed-grapes.jpg" alt="Crushed grapes">
		<figcaption>
			<button>Show information</button>
			<p>
	...
	<figure class="wine-barriques red">
		<img src="./assets/images/info/wine-barriques.jpg" alt="Wine barriques">
		<figcaption>
			<button>Show information</button>
			<p>
...
<section class="notice">
	<article>
		<div>
			...
			<span class="signature">
				<img src="./assets/images/lightfoot-signatures.svg" alt="Michael and Jocelyn Lightfoot signatures">
			</span>
			</p>
		</div>
	</article>
